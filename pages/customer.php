...
if(isset($_POST['submit'])){
    ...
    $_SESSION['mobile_person'] = $CMobile= $_POST['mobile_person'];
    $_SESSION['email_person'] = $CEmail = $_POST['email_person'];
    $_SESSION['comment'] = $CComment = $_POST['comment'];
     //echo $CCompany . $CContactPerson . $CMobile . $CEmail . $CComment;
    $query = mysqli_query($connection, "INSERT INTO custdb(CCompany, CContactPerson, CMobile, CEmail, CComment) VALUES('$CCompany', '$CContactPerson', '$CMobile', '$CEmail', '$CComment')");
    if(!$query){
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6">
                        <form action="" method="post" id="userForm">
                            ...
                            <div class="form-group" center>
                                <label>Mobile</label>
                                <input type="text" name="mobile_person" class="form-control" placeholder="Mobile" required>
                            </div>
                            <div class="form-group" center>
                                <label>Email</label>
                            ...
                            <div class="modal-footer"center>
                                <div id="container">
                                    ...
                                    <input type="submit" name="submit" id="submit_btn" class="btn btn-primary" value="Submit">
                                </div>
                            </div>
                        </form>
                    </div>
