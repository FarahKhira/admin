...
<head>
    ...
    <title>Staff-Customer Output</title>
        ...
        <div class="sidebar" role="navigation">
            <div class="sidebar-nav collapse navbar-collapse show" id="side-menu-wrapper">
                <ul class="nav navbar-nav navbar-collapse flex-column side-nav list-group" id="side-menu">
                    ...
                    <li class="list-group-item">
                        <a href="#"><i class="fa fa-tags"></i> Customers </a>
                    </li>
                    <li class="list-group-item">
                        <a href="#"><i class="fa fa-tags"></i> New Customers </a>
                    </li>
                    <li class="list-group-item">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="modal-footer">
                            <div id="container">
                                <button type="submit" name="back" class="btn btn-primary" id="Back" onClick="javascript:window.location.href='index.php'; return false">Back</button>
