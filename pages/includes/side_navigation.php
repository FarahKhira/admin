tem"><div class="sidebar" role="navigation">
                   ...
                   <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                        ...
                        <ul class="nav-second-level list-group nested">
                            <li class="list-group-item">
                                <a href="product_add.php"> Manage Product </a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li class="list-group-item">
                        ...
                        <ul class="nav-second-level list-group nested">
                            <li class="list-group-item">
                                <a href="customer_add.php"> Insert Customer </a>
                            </li>
                            <li class="list-group-item">
                                <a href="customer_order.php"> View Customer </a>
                            </li>
                        </ul>
                        <!-- /.nav-second -->
                    </li>
                    <li class="list-group-i
                        ...
                        <ul class="nav-second-level list-group nested">
                            <li class="list-group-item">
                                <a href="staff_add.php">Register Staff</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
